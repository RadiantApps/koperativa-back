...
const upload = multer({
  storage: multerS3({
    ...
    key: (req, file, cb) => {
      cb(null, `uploads/portfolio/content/${Date.now()}-${file.originalname}`);
    },
  }),
...
const uploadMiddlewarePortfolioContent = (req, res, next) => {
...
module.exports = uploadMiddlewarePortfolioContent;
